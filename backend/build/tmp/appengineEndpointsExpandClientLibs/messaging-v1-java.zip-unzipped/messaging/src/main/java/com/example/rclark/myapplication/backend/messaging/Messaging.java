 ...
 * on 2016-05-07 at 02:07:50 UTC 
 * Modify at your own risk.
 */

package com.example.rclark.myapplication.backend.messaging;
...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://default-demo-app-2c3f1.appspot.com/_ah/api/";
  ...
  /**
   * Create a request for the method "broadcastMessage".
   *
   * This request holds the parameters needed by the messaging server.  After setting any optional
   * parameters, call the {@link BroadcastMessage#execute()} method to invoke the remote operation.
   *
   * @param message
   * @return the request
   */
  public BroadcastMessage broadcastMessage(java.lang.String message) throws java.io.IOException {
    BroadcastMessage result = new BroadcastMessage(message);
    initialize(result);
    return result;
  }

  public class BroadcastMessage extends MessagingRequest<Void> {

    private static final String REST_PATH = "broadcastMessage/{message}";

    /**
     * Create a request for the method "broadcastMessage".
     *
     * This request holds the parameters needed by the the messaging server.  After setting any
     * optional parameters, call the {@link BroadcastMessage#execute()} method to invoke the remote
     * operation. <p> {@link BroadcastMessage#initialize(com.google.api.client.googleapis.services.Abs
     ...
     * @since 1.13
     */
    protected BroadcastMessage(java.lang.String message) {
      super(Messaging.this, "POST", REST_PATH, null, Void.class);
      this.message = com.google.api.client.util.Preconditions.checkNotNull(message, "Required parameter message must be specified.");
    }

    @Override
    public BroadcastMessage setAlt(java.lang.String alt) {
      return (BroadcastMessage) super.setAlt(alt);
    }

    @Override
    public BroadcastMessage setFields(java.lang.String fields) {
      return (BroadcastMessage) super.setFields(fields);
    }

    @Override
    public BroadcastMessage setKey(java.lang.String key) {
      return (BroadcastMessage) super.setKey(key);
    }

    @Override
    public BroadcastMessage setOauthToken(java.lang.String oauthToken) {
      return (BroadcastMessage) super.setOauthToken(oauthToken);
    }

    @Override
    public BroadcastMessage setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (BroadcastMessage) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public BroadcastMessage setQuotaUser(java.lang.String quotaUser) {
      return (BroadcastMessage) super.setQuotaUser(quotaUser);
    }

    @Override
    public BroadcastMessage setUserIp(java.lang.String userIp) {
      return (BroadcastMessage) super.setUserIp(userIp);
    }
    ...
    public BroadcastMessage setMessage(java.lang.String message) {
      this.message = message;
      return this;
    }

    @Override
    public BroadcastMessage set(String parameterName, Object value) {
      return (BroadcastMessage) super.set(parameterName, value);
    }
  }
   ...
   * @return the request
   */
  public SayHi sayHi(java.lang.String message) throws java.io.IOException {
    SayHi result = new SayHi(message);
    initialize(result);
    return result;
  }

  public class SayHi extends MessagingRequest<com.example.rclark.myapplication.backend.messaging.model.MyBean> {

    private static final String REST_PATH = "sayHi/{message}";
     ...
     * @since 1.13
     */
    protected SayHi(java.lang.String message) {
      super(Messaging.this, "POST", REST_PATH, null, com.example.rclark.myapplication.backend.messaging.model.MyBean.class);
      this.message = com.google.api.client.util.Preconditions.checkNotNull(message, "Required parameter message must be specified.");
    }
    ...
    public SayHi setMessage(java.lang.String message) {
      this.message = message;
      return this;
    }
